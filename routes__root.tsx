...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { title: "Suggestify Pro — Hybrid Recommendations" },
      { name: "description", content: "Personalized recommendations powered by hybrid collaborative + content-based AI." },
    ],
...
function RootComponent() {
  return (<AuthProvider><Outlet /><Toaster richColors position="top-center" /></AuthProvider>);
}
